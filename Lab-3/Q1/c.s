...
00000000000015ad <main>:
    ...
    169e:	00 00 00 
    16a1:	c7 85 0c ff ff ff 3e 	movl   $0x3e,-0xf4(%rbp)
    16a8:	00 00 00 
    16ab:	48 8d 85 c0 fe ff ff 	lea    -0x140(%rbp),%rax
    16b2:	49 89 c4             	mov    %rax,%r12
    16b5:	41 bd 14 00 00 00    	mov    $0x14,%r13d
    16bb:	4c 89 e1             	mov    %r12,%rcx
    16be:	4c 89 eb             	mov    %r13,%rbx
    16c1:	4c 89 e0             	mov    %r12,%rax
    16c4:	4c 89 ea             	mov    %r13,%rdx
    16c7:	48 89 d0             	mov    %rdx,%rax
    16ca:	48 89 ce             	mov    %rcx,%rsi
    16cd:	48 89 c2             	mov    %rax,%rdx
    16d0:	48 8d 3d a9 3b 00 00 	lea    0x3ba9(%rip),%rdi        # 5280 <v>
    16d7:	e8 a2 02 00 00       	callq  197e <std::vector<int, std::allocator<int> >::operator=(std::initializer_list<int>)>
    16dc:	48 8d 35 a7 1a 00 00 	lea    0x1aa7(%rip),%rsi        # 318a <std::__detail::_S_invalid_state_id+0xe2>
    16e3:	48 8d 3d 56 39 00 00 	lea    0x3956(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    16ea:	e8 61 fb ff ff       	callq  1250 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    16ef:	48 8d 85 bc fe ff ff 	lea    -0x144(%rbp),%rax
    16f6:	48 89 c6             	mov    %rax,%rsi
    16f9:	48 8d 3d 60 3a 00 00 	lea    0x3a60(%rip),%rdi        # 5160 <std::cin@@GLIBCXX_3.4>
    1700:	e8 0b fb ff ff       	callq  1210 <std::istream::operator>>(int&)@plt>
    1705:	48 8d 35 9c 1a 00 00 	lea    0x1a9c(%rip),%rsi        # 31a8 <std::__detail::_S_invalid_state_id+0x100>
    170c:	48 8d 3d 2d 39 00 00 	lea    0x392d(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    1713:	e8 38 fb ff ff       	callq  1250 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    1718:	48 8d 85 10 ff ff ff 	lea    -0xf0(%rbp),%rax
    171f:	48 89 c6             	mov    %rax,%rsi
    1722:	48 8d 3d 9f 1a 00 00 	lea    0x1a9f(%rip),%rdi        # 31c8 <std::__detail::_S_invalid_state_id+0x120>
    1729:	b8 00 00 00 00       	mov    $0x0,%eax
    172e:	e8 4d fb ff ff       	callq  1280 <__isoc99_scanf@plt>
    1733:	8b 85 bc fe ff ff    	mov    -0x144(%rbp),%eax
    1739:	83 c0 08             	add    $0x8,%eax
    173c:	89 c7                	mov    %eax,%edi
    173e:	e8 fd fa ff ff       	callq  1240 <srand@plt>
    1743:	48 8d 85 10 ff ff ff 	lea    -0xf0(%rbp),%rax
    174a:	48 89 c7             	mov    %rax,%rdi
    174d:	e8 b7 fc ff ff       	callq  1409 <part_c(char*)>
    1752:	b8 00 00 00 00       	mov    $0x0,%eax
    1757:	48 8b 5d d8          	mov    -0x28(%rbp),%rbx
    175b:	64 48 33 1c 25 28 00 	xor    %fs:0x28,%rbx
    1762:	00 00 
    1764:	74 05                	je     176b <main+0x1be>
    1766:	e8 05 fb ff ff       	callq  1270 <__stack_chk_fail@plt>
    176b:	48 81 c4 38 01 00 00 	add    $0x138,%rsp
    1772:	5b                   	pop    %rbx
    1773:	41 5c                	pop    %r12
    1775:	41 5d                	pop    %r13
    1777:	5d                   	pop    %rbp
...
0000000000001779 <__static_initialization_and_destruction_0(int, int)>:
    ...
    177d:	55                   	push   %rbp
    177e:	48 89 e5             	mov    %rsp,%rbp
    1781:	48 83 ec 10          	sub    $0x10,%rsp
    1785:	89 7d fc             	mov    %edi,-0x4(%rbp)
    1788:	89 75 f8             	mov    %esi,-0x8(%rbp)
    178b:	83 7d fc 01          	cmpl   $0x1,-0x4(%rbp)
    178f:	75 58                	jne    17e9 <__static_initialization_and_destruction_0(int, int)+0x70>
    1791:	81 7d f8 ff ff 00 00 	cmpl   $0xffff,-0x8(%rbp)
    1798:	75 4f                	jne    17e9 <__static_initialization_and_destruction_0(int, int)+0x70>
    179a:	48 8d 3d f7 3a 00 00 	lea    0x3af7(%rip),%rdi        # 5298 <std::__ioinit>
    17a1:	e8 2a fb ff ff       	callq  12d0 <std::ios_base::Init::Init()@plt>
    17a6:	48 8d 15 5b 38 00 00 	lea    0x385b(%rip),%rdx        # 5008 <__dso_handle>
    17ad:	48 8d 35 e4 3a 00 00 	lea    0x3ae4(%rip),%rsi        # 5298 <std::__ioinit>
    17b4:	48 8b 05 3d 38 00 00 	mov    0x383d(%rip),%rax        # 4ff8 <std::ios_base::Init::~Init()@GLIBCXX_3.4>
    17bb:	48 89 c7             	mov    %rax,%rdi
    17be:	e8 5d fa ff ff       	callq  1220 <__cxa_atexit@plt>
    17c3:	48 8d 3d b6 3a 00 00 	lea    0x3ab6(%rip),%rdi        # 5280 <v>
    17ca:	e8 a5 00 00 00       	callq  1874 <std::vector<int, std::allocator<int> >::vector()>
    17cf:	48 8d 15 32 38 00 00 	lea    0x3832(%rip),%rdx        # 5008 <__dso_handle>
    17d6:	48 8d 35 a3 3a 00 00 	lea    0x3aa3(%rip),%rsi        # 5280 <v>
    17dd:	48 8d 3d a4 0c 00 00 	lea    0xca4(%rip),%rdi        # 2488 <std::vector<int, std::allocator<int> >::~vector()>
    17e4:	e8 37 fa ff ff       	callq  1220 <__cxa_atexit@plt>
    17e9:	90                   	nop
    17ea:	c9                   	leaveq 
    17eb:	c3                   	retq   
...
00000000000017ec <_GLOBAL__sub_I_letters>:
    ...
    17f4:	be ff ff 00 00       	mov    $0xffff,%esi
    17f9:	bf 01 00 00 00       	mov    $0x1,%edi
    17fe:	e8 76 ff ff ff       	callq  1779 <__static_initialization_and_destruction_0(int, int)>
    1803:	5d                   	pop    %rbp
    1804:	c3                   	retq   
...
0000000000001805 <unsigned long const& std::min<unsigned long>(unsigned long const&, unsigned long const&)>:
    ...
    180d:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
    1811:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
    1815:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1819:	48 8b 10             	mov    (%rax),%rdx
    181c:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1820:	48 8b 00             	mov    (%rax),%rax
    1823:	48 39 c2             	cmp    %rax,%rdx
    1826:	73 06                	jae    182e <unsigned long const& std::min<unsigned long>(unsigned long const&, unsigned long const&)+0x29>
    1828:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
...
00000000000020df <std::vector<int, std::allocator<int> >::_S_max_size(std::allocator<int> const&)>:
    ...
    212a:	e8 d6 f6 ff ff       	callq  1805 <unsigned long const& std::min<unsigned long>(unsigned long const&, unsigned long const&)>
