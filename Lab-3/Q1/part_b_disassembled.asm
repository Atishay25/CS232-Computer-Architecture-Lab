...
0000000000001170 <std::__throw_bad_alloc()@plt>:
    1170:	f3 0f 1e fa          	endbr64 
    1174:	f2 ff 25 cd 3d 00 00 	bnd jmpq *0x3dcd(%rip)        # 4f48 <std::__throw_bad_alloc()@GLIBCXX_3.4>
...
0000000000001190 <std::__throw_length_error(char const*)@plt>:
    1190:	f3 0f 1e fa          	endbr64 
    1194:	f2 ff 25 bd 3d 00 00 	bnd jmpq *0x3dbd(%rip)        # 4f58 <std::__throw_length_error(char const*)@GLIBCXX_3.4>
    119b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000011a0 <std::istream::operator>>(int&)@plt>:
    11a0:	f3 0f 1e fa          	endbr64 
    11a4:	f2 ff 25 b5 3d 00 00 	bnd jmpq *0x3db5(%rip)        # 4f60 <std::istream::operator>>(int&)@GLIBCXX_3.4>
...
00000000000011c0 <operator delete(void*)@plt>:
    11c0:	f3 0f 1e fa          	endbr64 
    11c4:	f2 ff 25 a5 3d 00 00 	bnd jmpq *0x3da5(%rip)        # 4f70 <operator delete(void*)@GLIBCXX_3.4>
...
00000000000011e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>:
    11e0:	f3 0f 1e fa          	endbr64 
    11e4:	f2 ff 25 95 3d 00 00 	bnd jmpq *0x3d95(%rip)        # 4f80 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@GLIBCXX_3.4>
    11eb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000011f0 <operator new(unsigned long)@plt>:
    11f0:	f3 0f 1e fa          	endbr64 
    11f4:	f2 ff 25 8d 3d 00 00 	bnd jmpq *0x3d8d(%rip)        # 4f88 <operator new(unsigned long)@GLIBCXX_3.4>
...
0000000000001210 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char)@plt>:
    1210:	f3 0f 1e fa          	endbr64 
    1214:	f2 ff 25 7d 3d 00 00 	bnd jmpq *0x3d7d(%rip)        # 4f98 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char)@GLIBCXX_3.4>
...
0000000000001260 <std::ostream::operator<<(int)@plt>:
    1260:	f3 0f 1e fa          	endbr64 
    1264:	f2 ff 25 55 3d 00 00 	bnd jmpq *0x3d55(%rip)        # 4fc0 <std::ostream::operator<<(int)@GLIBCXX_3.4>
...
0000000000001369 <part_b(int, int, int)>:
    ...
    1397:	0f 85 a2 00 00 00    	jne    143f <part_b(int, int, int)+0xd6>
    139d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
    13a4:	48 8d 3d d5 3e 00 00 	lea    0x3ed5(%rip),%rdi        # 5280 <v>
    13ab:	e8 cc 03 00 00       	callq  177c <std::vector<int, std::allocator<int> >::size() const>
    13b0:	39 45 ec             	cmp    %eax,-0x14(%rbp)
    13b3:	0f 9c c0             	setl   %al
    13b6:	84 c0                	test   %al,%al
    13b8:	74 3c                	je     13f6 <part_b(int, int, int)+0x8d>
    ...
    13d0:	e8 cf 03 00 00       	callq  17a4 <std::vector<int, std::allocator<int> >::operator[](unsigned long)>
    ...
    13e4:	48 8d 3d 55 3c 00 00 	lea    0x3c55(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    13eb:	e8 20 fe ff ff       	callq  1210 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char)@plt>
    13f0:	83 45 ec 01          	addl   $0x1,-0x14(%rbp)
    13f4:	eb ae                	jmp    13a4 <part_b(int, int, int)+0x3b>
    13f6:	48 8d 35 0c 1d 00 00 	lea    0x1d0c(%rip),%rsi        # 3109 <std::__detail::_S_invalid_state_id+0x61>
    13fd:	48 8d 3d 3c 3c 00 00 	lea    0x3c3c(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    1404:	e8 d7 fd ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    1409:	48 8d 35 fb 1c 00 00 	lea    0x1cfb(%rip),%rsi        # 310b <std::__detail::_S_invalid_state_id+0x63>
    1410:	48 8d 3d 29 3c 00 00 	lea    0x3c29(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    1417:	e8 c4 fd ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    141c:	48 89 c3             	mov    %rax,%rbx
    141f:	e8 3c fd ff ff       	callq  1160 <rand@plt>
    1424:	89 c6                	mov    %eax,%esi
    1426:	48 89 df             	mov    %rbx,%rdi
    1429:	e8 32 fe ff ff       	callq  1260 <std::ostream::operator<<(int)@plt>
    142e:	48 8d 35 d4 1c 00 00 	lea    0x1cd4(%rip),%rsi        # 3109 <std::__detail::_S_invalid_state_id+0x61>
    1435:	48 89 c7             	mov    %rax,%rdi
    1438:	e8 a3 fd ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    143d:	eb 13                	jmp    1452 <part_b(int, int, int)+0xe9>
    143f:	48 8d 35 dd 1c 00 00 	lea    0x1cdd(%rip),%rsi        # 3123 <std::__detail::_S_invalid_state_id+0x7b>
    1446:	48 8d 3d f3 3b 00 00 	lea    0x3bf3(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    144d:	e8 8e fd ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    1452:	90                   	nop
...
000000000000145a <main>:
    ...
    147a:	48 8d 35 b7 1c 00 00 	lea    0x1cb7(%rip),%rsi        # 3138 <std::__detail::_S_invalid_state_id+0x90>
    1481:	48 8d 3d b8 3b 00 00 	lea    0x3bb8(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    1488:	e8 53 fd ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    ...
    14fc:	e8 c7 02 00 00       	callq  17c8 <std::vector<int, std::allocator<int> >::operator=(std::initializer_list<int>)>
    1501:	48 8d 35 81 1c 00 00 	lea    0x1c81(%rip),%rsi        # 3189 <std::__detail::_S_invalid_state_id+0xe1>
    1508:	48 8d 3d 31 3b 00 00 	lea    0x3b31(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    150f:	e8 cc fc ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    1514:	48 8d 45 ac          	lea    -0x54(%rbp),%rax
    1518:	48 89 c6             	mov    %rax,%rsi
    151b:	48 8d 3d 3e 3c 00 00 	lea    0x3c3e(%rip),%rdi        # 5160 <std::cin@@GLIBCXX_3.4>
    1522:	e8 79 fc ff ff       	callq  11a0 <std::istream::operator>>(int&)@plt>
    1527:	48 8d 35 7a 1c 00 00 	lea    0x1c7a(%rip),%rsi        # 31a8 <std::__detail::_S_invalid_state_id+0x100>
    152e:	48 8d 3d 0b 3b 00 00 	lea    0x3b0b(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    1535:	e8 a6 fc ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    153a:	48 8d 45 a0          	lea    -0x60(%rbp),%rax
    153e:	48 89 c6             	mov    %rax,%rsi
    1541:	48 8d 3d 18 3c 00 00 	lea    0x3c18(%rip),%rdi        # 5160 <std::cin@@GLIBCXX_3.4>
    1548:	e8 53 fc ff ff       	callq  11a0 <std::istream::operator>>(int&)@plt>
    154d:	48 89 c2             	mov    %rax,%rdx
    1550:	48 8d 45 a4          	lea    -0x5c(%rbp),%rax
    1554:	48 89 c6             	mov    %rax,%rsi
    1557:	48 89 d7             	mov    %rdx,%rdi
    155a:	e8 41 fc ff ff       	callq  11a0 <std::istream::operator>>(int&)@plt>
    155f:	48 89 c2             	mov    %rax,%rdx
    1562:	48 8d 45 a8          	lea    -0x58(%rbp),%rax
    1566:	48 89 c6             	mov    %rax,%rsi
    1569:	48 89 d7             	mov    %rdx,%rdi
    156c:	e8 2f fc ff ff       	callq  11a0 <std::istream::operator>>(int&)@plt>
    ...
    1599:	e8 cb fd ff ff       	callq  1369 <part_b(int, int, int)>
...
00000000000015c2 <__static_initialization_and_destruction_0(int, int)>:
    ...
    15d8:	75 58                	jne    1632 <__static_initialization_and_destruction_0(int, int)+0x70>
    15da:	81 7d f8 ff ff 00 00 	cmpl   $0xffff,-0x8(%rbp)
    15e1:	75 4f                	jne    1632 <__static_initialization_and_destruction_0(int, int)+0x70>
    15e3:	48 8d 3d ae 3c 00 00 	lea    0x3cae(%rip),%rdi        # 5298 <std::__ioinit>
    15ea:	e8 41 fc ff ff       	callq  1230 <std::ios_base::Init::Init()@plt>
    15ef:	48 8d 15 12 3a 00 00 	lea    0x3a12(%rip),%rdx        # 5008 <__dso_handle>
    15f6:	48 8d 35 9b 3c 00 00 	lea    0x3c9b(%rip),%rsi        # 5298 <std::__ioinit>
    15fd:	48 8b 05 f4 39 00 00 	mov    0x39f4(%rip),%rax        # 4ff8 <std::ios_base::Init::~Init()@GLIBCXX_3.4>
    ...
    1613:	e8 a6 00 00 00       	callq  16be <std::vector<int, std::allocator<int> >::vector()>
    1618:	48 8d 15 e9 39 00 00 	lea    0x39e9(%rip),%rdx        # 5008 <__dso_handle>
    161f:	48 8d 35 5a 3c 00 00 	lea    0x3c5a(%rip),%rsi        # 5280 <v>
    1626:	48 8d 3d a5 0c 00 00 	lea    0xca5(%rip),%rdi        # 22d2 <std::vector<int, std::allocator<int> >::~vector()>
...
0000000000001635 <_GLOBAL__sub_I_letters>:
    ...
    1647:	e8 76 ff ff ff       	callq  15c2 <__static_initialization_and_destruction_0(int, int)>
    164c:	5d                   	pop    %rbp
    164d:	c3                   	retq   

000000000000164e <unsigned long const& std::min<unsigned long>(unsigned long const&, unsigned long const&)>:
    ...
    166f:	73 06                	jae    1677 <unsigned long const& std::min<unsigned long>(unsigned long const&, unsigned long const&)+0x29>
    1671:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1675:	eb 04                	jmp    167b <unsigned long const& std::min<unsigned long>(unsigned long const&, unsigned long const&)+0x2d>
    1677:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    167b:	5d                   	pop    %rbp
    167c:	c3                   	retq   
    167d:	90                   	nop

000000000000167e <std::_Vector_base<int, std::allocator<int> >::_Vector_impl::~_Vector_impl()>:
    ...
    1695:	e8 70 00 00 00       	callq  170a <std::allocator<int>::~allocator()>
    169a:	90                   	nop
    169b:	c9                   	leaveq 
    169c:	c3                   	retq   
    169d:	90                   	nop

000000000000169e <std::_Vector_base<int, std::allocator<int> >::_Vector_base()>:
    ...
    16b5:	e8 24 00 00 00       	callq  16de <std::_Vector_base<int, std::allocator<int> >::_Vector_impl::_Vector_impl()>
    16ba:	90                   	nop
    16bb:	c9                   	leaveq 
    16bc:	c3                   	retq   
    16bd:	90                   	nop

00000000000016be <std::vector<int, std::allocator<int> >::vector()>:
    ...
    16d5:	e8 c4 ff ff ff       	callq  169e <std::_Vector_base<int, std::allocator<int> >::_Vector_base()>
    16da:	90                   	nop
    16db:	c9                   	leaveq 
    16dc:	c3                   	retq   
    16dd:	90                   	nop

00000000000016de <std::_Vector_base<int, std::allocator<int> >::_Vector_impl::_Vector_impl()>:
    ...
    16f5:	e8 52 01 00 00       	callq  184c <std::allocator<int>::allocator()>
    16fa:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    16fe:	48 89 c7             	mov    %rax,%rdi
    1701:	e8 66 01 00 00       	callq  186c <std::_Vector_base<int, std::allocator<int> >::_Vector_impl_data::_Vector_impl_data()>
    1706:	90                   	nop
    1707:	c9                   	leaveq 
    1708:	c3                   	retq   
    1709:	90                   	nop

000000000000170a <std::allocator<int>::~allocator()>:
    ...
    1721:	e8 78 01 00 00       	callq  189e <__gnu_cxx::new_allocator<int>::~new_allocator()>
    1726:	90                   	nop
    1727:	c9                   	leaveq 
    1728:	c3                   	retq   
    1729:	90                   	nop

000000000000172a <std::_Vector_base<int, std::allocator<int> >::~_Vector_base()>:
    ...
    1767:	e8 42 01 00 00       	callq  18ae <std::_Vector_base<int, std::allocator<int> >::_M_deallocate(int*, unsigned long)>
    176c:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1770:	48 89 c7             	mov    %rax,%rdi
    1773:	e8 06 ff ff ff       	callq  167e <std::_Vector_base<int, std::allocator<int> >::_Vector_impl::~_Vector_impl()>
    1778:	90                   	nop
    1779:	c9                   	leaveq 
    177a:	c3                   	retq   
    177b:	90                   	nop

000000000000177c <std::vector<int, std::allocator<int> >::size() const>:
...
00000000000017a4 <std::vector<int, std::allocator<int> >::operator[](unsigned long)>:
...
00000000000017c8 <std::vector<int, std::allocator<int> >::operator=(std::initializer_list<int>)>:
    ...
    1803:	e8 f6 00 00 00       	callq  18fe <std::initializer_list<int>::end() const>
    1808:	48 89 c3             	mov    %rax,%rbx
    180b:	48 8d 45 c0          	lea    -0x40(%rbp),%rax
    180f:	48 89 c7             	mov    %rax,%rdi
    1812:	e8 d1 00 00 00       	callq  18e8 <std::initializer_list<int>::begin() const>
    ...
    1827:	e8 0c 01 00 00       	callq  1938 <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)>
    182c:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    1830:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx
    1834:	64 48 33 14 25 28 00 	xor    %fs:0x28,%rdx
    183b:	00 00 
    183d:	74 05                	je     1844 <std::vector<int, std::allocator<int> >::operator=(std::initializer_list<int>)+0x7c>
...
000000000000184c <std::allocator<int>::allocator()>:
    ...
    1863:	e8 e4 02 00 00       	callq  1b4c <__gnu_cxx::new_allocator<int>::new_allocator()>
    1868:	90                   	nop
    1869:	c9                   	leaveq 
    186a:	c3                   	retq   
    186b:	90                   	nop

000000000000186c <std::_Vector_base<int, std::allocator<int> >::_Vector_impl_data::_Vector_impl_data()>:
...
000000000000189e <__gnu_cxx::new_allocator<int>::~new_allocator()>:
...
00000000000018ae <std::_Vector_base<int, std::allocator<int> >::_M_deallocate(int*, unsigned long)>:
    ...
    18cb:	74 17                	je     18e4 <std::_Vector_base<int, std::allocator<int> >::_M_deallocate(int*, unsigned long)+0x36>
    ...
    18df:	e8 77 02 00 00       	callq  1b5b <std::allocator_traits<std::allocator<int> >::deallocate(std::allocator<int>&, int*, unsigned long)>
    18e4:	90                   	nop
    18e5:	c9                   	leaveq 
    18e6:	c3                   	retq   
    18e7:	90                   	nop

00000000000018e8 <std::initializer_list<int>::begin() const>:
...
00000000000018fe <std::initializer_list<int>::end() const>:
    ...
    1916:	e8 cd ff ff ff       	callq  18e8 <std::initializer_list<int>::begin() const>
    191b:	48 89 c3             	mov    %rax,%rbx
    191e:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1922:	48 89 c7             	mov    %rax,%rdi
    1925:	e8 64 02 00 00       	callq  1b8e <std::initializer_list<int>::size() const>
...
0000000000001938 <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)>:
    ...
    196d:	e8 32 02 00 00       	callq  1ba4 <std::iterator_traits<int const*>::difference_type std::distance<int const*>(int const*, int const*)>
    1972:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    1976:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    197a:	48 89 c7             	mov    %rax,%rdi
    197d:	e8 7a 02 00 00       	callq  1bfc <std::vector<int, std::allocator<int> >::capacity() const>
    1982:	48 39 45 e0          	cmp    %rax,-0x20(%rbp)
    1986:	0f 97 c0             	seta   %al
    1989:	84 c0                	test   %al,%al
    198b:	0f 84 d2 00 00 00    	je     1a63 <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)+0x12b>
    1991:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1995:	48 89 c7             	mov    %rax,%rdi
    1998:	e8 0b 03 00 00       	callq  1ca8 <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    199d:	48 89 c2             	mov    %rax,%rdx
    19a0:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    19a4:	48 89 d6             	mov    %rdx,%rsi
    19a7:	48 89 c7             	mov    %rax,%rdi
    19aa:	e8 74 02 00 00       	callq  1c23 <std::vector<int, std::allocator<int> >::_S_check_init_len(unsigned long, std::allocator<int> const&)>
    ...
    19c2:	e8 f3 02 00 00       	callq  1cba <int* std::vector<int, std::allocator<int> >::_M_allocate_and_copy<int const*>(unsigned long, int const*, int const*)>
    19c7:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    19cb:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    19cf:	48 89 c7             	mov    %rax,%rdi
    19d2:	e8 d1 02 00 00       	callq  1ca8 <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    ...
    19ef:	e8 69 03 00 00       	callq  1d5d <void std::_Destroy<int*, int>(int*, int*, std::allocator<int>&)>
    ...
    1a24:	e8 85 fe ff ff       	callq  18ae <std::_Vector_base<int, std::allocator<int> >::_M_deallocate(int*, unsigned long)>
    ...
    1a5e:	e9 d1 00 00 00       	jmpq   1b34 <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)+0x1fc>
    1a63:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1a67:	48 89 c7             	mov    %rax,%rdi
    1a6a:	e8 0d fd ff ff       	callq  177c <std::vector<int, std::allocator<int> >::size() const>
    1a6f:	48 39 45 e0          	cmp    %rax,-0x20(%rbp)
    1a73:	0f 96 c0             	setbe  %al
    1a76:	84 c0                	test   %al,%al
    1a78:	74 31                	je     1aab <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)+0x173>
    ...
    1a8f:	e8 5c 03 00 00       	callq  1df0 <int* std::copy<int const*, int*>(int const*, int const*, int*)>
    1a94:	48 89 c2             	mov    %rax,%rdx
    1a97:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1a9b:	48 89 d6             	mov    %rdx,%rsi
    1a9e:	48 89 c7             	mov    %rax,%rdi
    1aa1:	e8 e6 02 00 00       	callq  1d8c <std::vector<int, std::allocator<int> >::_M_erase_at_end(int*)>
    1aa6:	e9 89 00 00 00       	jmpq   1b34 <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)+0x1fc>
    ...
    1aba:	e8 bd fc ff ff       	callq  177c <std::vector<int, std::allocator<int> >::size() const>
    1abf:	48 89 c2             	mov    %rax,%rdx
    1ac2:	48 8d 45 d8          	lea    -0x28(%rbp),%rax
    1ac6:	48 89 d6             	mov    %rdx,%rsi
    1ac9:	48 89 c7             	mov    %rax,%rdi
    1acc:	e8 6f 03 00 00       	callq  1e40 <void std::advance<int const*, unsigned long>(int const*&, unsigned long)>
    ...
    1ae6:	e8 05 03 00 00       	callq  1df0 <int* std::copy<int const*, int*>(int const*, int const*, int*)>
    1aeb:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1aef:	48 89 c7             	mov    %rax,%rdi
    1af2:	e8 85 fc ff ff       	callq  177c <std::vector<int, std::allocator<int> >::size() const>
    ...
    1b0c:	e8 97 01 00 00       	callq  1ca8 <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    ...
    1b27:	e8 75 03 00 00       	callq  1ea1 <int* std::__uninitialized_copy_a<int const*, int*, int>(int const*, int const*, int*, std::allocator<int>&)>
    ...
    1b40:	00 00 
    1b42:	74 05                	je     1b49 <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)+0x211>
    1b44:	e8 b7 f6 ff ff       	callq  1200 <__stack_chk_fail@plt>
    1b49:	c9                   	leaveq 
    1b4a:	c3                   	retq   
    1b4b:	90                   	nop

0000000000001b4c <__gnu_cxx::new_allocator<int>::new_allocator()>:
...
0000000000001b5b <std::allocator_traits<std::allocator<int> >::deallocate(std::allocator<int>&, int*, unsigned long)>:
    ...
    1b85:	e8 4c 03 00 00       	callq  1ed6 <__gnu_cxx::new_allocator<int>::deallocate(int*, unsigned long)>
    1b8a:	90                   	nop
    1b8b:	c9                   	leaveq 
    1b8c:	c3                   	retq   
    1b8d:	90                   	nop

0000000000001b8e <std::initializer_list<int>::size() const>:
...
0000000000001ba4 <std::iterator_traits<int const*>::difference_type std::distance<int const*>(int const*, int const*)>:
    ...
    1bce:	e8 2a 03 00 00       	callq  1efd <std::iterator_traits<int const*>::iterator_category std::__iterator_category<int const*>(int const* const&)>
    1bd3:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1bd7:	48 8b 55 e0          	mov    -0x20(%rbp),%rdx
    1bdb:	48 89 d6             	mov    %rdx,%rsi
    1bde:	48 89 c7             	mov    %rax,%rdi
    1be1:	e8 25 03 00 00       	callq  1f0b <std::iterator_traits<int const*>::difference_type std::__distance<int const*>(int const*, int const*, std::random_access_iterator_tag)>
    1be6:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1bea:	64 48 33 0c 25 28 00 	xor    %fs:0x28,%rcx
    1bf1:	00 00 
    1bf3:	74 05                	je     1bfa <std::iterator_traits<int const*>::difference_type std::distance<int const*>(int const*, int const*)+0x56>
    1bf5:	e8 06 f6 ff ff       	callq  1200 <__stack_chk_fail@plt>
    1bfa:	c9                   	leaveq 
    1bfb:	c3                   	retq   

0000000000001bfc <std::vector<int, std::allocator<int> >::capacity() const>:
...
0000000000001c23 <std::vector<int, std::allocator<int> >::_S_check_init_len(unsigned long, std::allocator<int> const&)>:
    ...
    1c55:	e8 38 03 00 00       	callq  1f92 <std::allocator<int>::allocator(std::allocator<int> const&)>
    1c5a:	48 8d 45 e7          	lea    -0x19(%rbp),%rax
    1c5e:	48 89 c7             	mov    %rax,%rdi
    1c61:	e8 c3 02 00 00       	callq  1f29 <std::vector<int, std::allocator<int> >::_S_max_size(std::allocator<int> const&)>
    1c66:	48 39 45 d8          	cmp    %rax,-0x28(%rbp)
    1c6a:	0f 97 c3             	seta   %bl
    1c6d:	48 8d 45 e7          	lea    -0x19(%rbp),%rax
    1c71:	48 89 c7             	mov    %rax,%rdi
    1c74:	e8 91 fa ff ff       	callq  170a <std::allocator<int>::~allocator()>
    1c79:	84 db                	test   %bl,%bl
    1c7b:	74 0c                	je     1c89 <std::vector<int, std::allocator<int> >::_S_check_init_len(unsigned long, std::allocator<int> const&)+0x66>
    1c7d:	48 8d 3d 44 15 00 00 	lea    0x1544(%rip),%rdi        # 31c8 <std::__detail::_S_invalid_state_id+0x120>
    1c84:	e8 07 f5 ff ff       	callq  1190 <std::__throw_length_error(char const*)@plt>
    1c89:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    1c8d:	48 8b 4d e8          	mov    -0x18(%rbp),%rcx
    1c91:	64 48 33 0c 25 28 00 	xor    %fs:0x28,%rcx
    1c98:	00 00 
    1c9a:	74 05                	je     1ca1 <std::vector<int, std::allocator<int> >::_S_check_init_len(unsigned long, std::allocator<int> const&)+0x7e>
...
0000000000001ca8 <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>:
...
0000000000001cba <int* std::vector<int, std::allocator<int> >::_M_allocate_and_copy<int const*>(unsigned long, int const*, int const*)>:
    ...
    1ce5:	e8 d2 02 00 00       	callq  1fbc <std::_Vector_base<int, std::allocator<int> >::_M_allocate(unsigned long)>
    1cea:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    1cee:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    1cf2:	48 89 c7             	mov    %rax,%rdi
    1cf5:	e8 ae ff ff ff       	callq  1ca8 <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    ...
    1d0c:	e8 90 01 00 00       	callq  1ea1 <int* std::__uninitialized_copy_a<int const*, int*, int>(int const*, int const*, int*, std::allocator<int>&)>
    1d11:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1d15:	eb 3f                	jmp    1d56 <int* std::vector<int, std::allocator<int> >::_M_allocate_and_copy<int const*>(unsigned long, int const*, int const*)+0x9c>
    ...
    1d35:	e8 74 fb ff ff       	callq  18ae <std::_Vector_base<int, std::allocator<int> >::_M_deallocate(int*, unsigned long)>
...
0000000000001d5d <void std::_Destroy<int*, int>(int*, int*, std::allocator<int>&)>:
    ...
    1d83:	e8 6b 02 00 00       	callq  1ff3 <void std::_Destroy<int*>(int*, int*)>
    1d88:	90                   	nop
    1d89:	c9                   	leaveq 
    1d8a:	c3                   	retq   
    1d8b:	90                   	nop

0000000000001d8c <std::vector<int, std::allocator<int> >::_M_erase_at_end(int*)>:
    ...
    1db9:	74 32                	je     1ded <std::vector<int, std::allocator<int> >::_M_erase_at_end(int*)+0x61>
    1dbb:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1dbf:	48 89 c7             	mov    %rax,%rdi
    1dc2:	e8 e1 fe ff ff       	callq  1ca8 <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    ...
    1ddc:	e8 7c ff ff ff       	callq  1d5d <void std::_Destroy<int*, int>(int*, int*, std::allocator<int>&)>
...
0000000000001df0 <int* std::copy<int const*, int*>(int const*, int const*, int*)>:
    ...
    1e10:	e8 08 02 00 00       	callq  201d <int const* std::__miter_base<int const*>(int const*)>
    1e15:	48 89 c3             	mov    %rax,%rbx
    1e18:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1e1c:	48 89 c7             	mov    %rax,%rdi
    1e1f:	e8 f9 01 00 00       	callq  201d <int const* std::__miter_base<int const*>(int const*)>
    ...
    1e34:	e8 f6 01 00 00       	callq  202f <int* std::__copy_move_a2<false, int const*, int*>(int const*, int const*, int*)>
    1e39:	48 83 c4 28          	add    $0x28,%rsp
    1e3d:	5b                   	pop    %rbx
    1e3e:	5d                   	pop    %rbp
    1e3f:	c3                   	retq   

0000000000001e40 <void std::advance<int const*, unsigned long>(int const*&, unsigned long)>:
    ...
    1e72:	e8 86 00 00 00       	callq  1efd <std::iterator_traits<int const*>::iterator_category std::__iterator_category<int const*>(int const* const&)>
    1e77:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    1e7b:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    1e7f:	48 89 d6             	mov    %rdx,%rsi
    1e82:	48 89 c7             	mov    %rax,%rdi
    1e85:	e8 13 02 00 00       	callq  209d <void std::__advance<int const*, long>(int const*&, long, std::random_access_iterator_tag)>
    1e8a:	90                   	nop
    1e8b:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1e8f:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax
    1e96:	00 00 
    1e98:	74 05                	je     1e9f <void std::advance<int const*, unsigned long>(int const*&, unsigned long)+0x5f>
    1e9a:	e8 61 f3 ff ff       	callq  1200 <__stack_chk_fail@plt>
    1e9f:	c9                   	leaveq 
    1ea0:	c3                   	retq   

0000000000001ea1 <int* std::__uninitialized_copy_a<int const*, int*, int>(int const*, int const*, int*, std::allocator<int>&)>:
    ...
    1ecf:	e8 f5 01 00 00       	callq  20c9 <int* std::uninitialized_copy<int const*, int*>(int const*, int const*, int*)>
    1ed4:	c9                   	leaveq 
    1ed5:	c3                   	retq   

0000000000001ed6 <__gnu_cxx::new_allocator<int>::deallocate(int*, unsigned long)>:
    ...
    1ef5:	e8 c6 f2 ff ff       	callq  11c0 <operator delete(void*)@plt>
    1efa:	90                   	nop
    1efb:	c9                   	leaveq 
    1efc:	c3                   	retq   

0000000000001efd <std::iterator_traits<int const*>::iterator_category std::__iterator_category<int const*>(int const* const&)>:
...
0000000000001f0b <std::iterator_traits<int const*>::difference_type std::__distance<int const*>(int const*, int const*, std::random_access_iterator_tag)>:
...
0000000000001f29 <std::vector<int, std::allocator<int> >::_S_max_size(std::allocator<int> const&)>:
    ...
    1f5d:	e8 9c 01 00 00       	callq  20fe <std::allocator_traits<std::allocator<int> >::max_size(std::allocator<int> const&)>
    ...
    1f74:	e8 d5 f6 ff ff       	callq  164e <unsigned long const& std::min<unsigned long>(unsigned long const&, unsigned long const&)>
    1f79:	48 8b 00             	mov    (%rax),%rax
    1f7c:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1f80:	64 48 33 0c 25 28 00 	xor    %fs:0x28,%rcx
    1f87:	00 00 
    1f89:	74 05                	je     1f90 <std::vector<int, std::allocator<int> >::_S_max_size(std::allocator<int> const&)+0x67>
    1f8b:	e8 70 f2 ff ff       	callq  1200 <__stack_chk_fail@plt>
    1f90:	c9                   	leaveq 
    1f91:	c3                   	retq   

0000000000001f92 <std::allocator<int>::allocator(std::allocator<int> const&)>:
    ...
    1fb4:	e8 63 01 00 00       	callq  211c <__gnu_cxx::new_allocator<int>::new_allocator(__gnu_cxx::new_allocator<int> const&)>
    1fb9:	90                   	nop
    1fba:	c9                   	leaveq 
    1fbb:	c3                   	retq   

0000000000001fbc <std::_Vector_base<int, std::allocator<int> >::_M_allocate(unsigned long)>:
    ...
    1fd5:	74 15                	je     1fec <std::_Vector_base<int, std::allocator<int> >::_M_allocate(unsigned long)+0x30>
    1fd7:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1fdb:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    1fdf:	48 89 d6             	mov    %rdx,%rsi
    1fe2:	48 89 c7             	mov    %rax,%rdi
    1fe5:	e8 45 01 00 00       	callq  212f <std::allocator_traits<std::allocator<int> >::allocate(std::allocator<int>&, unsigned long)>
    1fea:	eb 05                	jmp    1ff1 <std::_Vector_base<int, std::allocator<int> >::_M_allocate(unsigned long)+0x35>
    1fec:	b8 00 00 00 00       	mov    $0x0,%eax
    1ff1:	c9                   	leaveq 
    1ff2:	c3                   	retq   

0000000000001ff3 <void std::_Destroy<int*>(int*, int*)>:
    ...
    2015:	e8 43 01 00 00       	callq  215d <void std::_Destroy_aux<true>::__destroy<int*>(int*, int*)>
    201a:	90                   	nop
    201b:	c9                   	leaveq 
    201c:	c3                   	retq   

000000000000201d <int const* std::__miter_base<int const*>(int const*)>:
...
000000000000202f <int* std::__copy_move_a2<false, int const*, int*>(int const*, int const*, int*)>:
    ...
    2051:	e8 2c 01 00 00       	callq  2182 <int* std::__niter_base<int*>(int*)>
    2056:	49 89 c4             	mov    %rax,%r12
    2059:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    205d:	48 89 c7             	mov    %rax,%rdi
    2060:	e8 0b 01 00 00       	callq  2170 <int const* std::__niter_base<int const*>(int const*)>
    2065:	48 89 c3             	mov    %rax,%rbx
    2068:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    206c:	48 89 c7             	mov    %rax,%rdi
    206f:	e8 fc 00 00 00       	callq  2170 <int const* std::__niter_base<int const*>(int const*)>
    2074:	4c 89 e2             	mov    %r12,%rdx
    2077:	48 89 de             	mov    %rbx,%rsi
    207a:	48 89 c7             	mov    %rax,%rdi
    207d:	e8 12 01 00 00       	callq  2194 <int* std::__copy_move_a<false, int const*, int*>(int const*, int const*, int*)>
    2082:	48 89 c2             	mov    %rax,%rdx
    2085:	48 8d 45 d8          	lea    -0x28(%rbp),%rax
    2089:	48 89 d6             	mov    %rdx,%rsi
    208c:	48 89 c7             	mov    %rax,%rdi
    208f:	e8 35 01 00 00       	callq  21c9 <int* std::__niter_wrap<int*>(int* const&, int*)>
...
000000000000209d <void std::__advance<int const*, long>(int const*&, long, std::random_access_iterator_tag)>:
...
00000000000020c9 <int* std::uninitialized_copy<int const*, int*>(int const*, int const*, int*)>:
    ...
    20f7:	e8 e3 00 00 00       	callq  21df <int* std::__uninitialized_copy<true>::__uninit_copy<int const*, int*>(int const*, int const*, int*)>
    20fc:	c9                   	leaveq 
    20fd:	c3                   	retq   

00000000000020fe <std::allocator_traits<std::allocator<int> >::max_size(std::allocator<int> const&)>:
    ...
    2115:	e8 f6 00 00 00       	callq  2210 <__gnu_cxx::new_allocator<int>::max_size() const>
    211a:	c9                   	leaveq 
    211b:	c3                   	retq   

000000000000211c <__gnu_cxx::new_allocator<int>::new_allocator(__gnu_cxx::new_allocator<int> const&)>:
...
000000000000212f <std::allocator_traits<std::allocator<int> >::allocate(std::allocator<int>&, unsigned long)>:
    ...
    2156:	e8 cd 00 00 00       	callq  2228 <__gnu_cxx::new_allocator<int>::allocate(unsigned long, void const*)>
    215b:	c9                   	leaveq 
    215c:	c3                   	retq   

000000000000215d <void std::_Destroy_aux<true>::__destroy<int*>(int*, int*)>:
...
0000000000002170 <int const* std::__niter_base<int const*>(int const*)>:
...
0000000000002182 <int* std::__niter_base<int*>(int*)>:
...
0000000000002194 <int* std::__copy_move_a<false, int const*, int*>(int const*, int const*, int*)>:
    ...
    21c2:	e8 a7 00 00 00       	callq  226e <int* std::__copy_move<false, true, std::random_access_iterator_tag>::__copy_m<int>(int const*, int const*, int*)>
    21c7:	c9                   	leaveq 
    21c8:	c3                   	retq   

00000000000021c9 <int* std::__niter_wrap<int*>(int* const&, int*)>:
...
00000000000021df <int* std::__uninitialized_copy<true>::__uninit_copy<int const*, int*>(int const*, int const*, int*)>:
    ...
    2209:	e8 e2 fb ff ff       	callq  1df0 <int* std::copy<int const*, int*>(int const*, int const*, int*)>
    220e:	c9                   	leaveq 
    220f:	c3                   	retq   

0000000000002210 <__gnu_cxx::new_allocator<int>::max_size() const>:
...
0000000000002228 <__gnu_cxx::new_allocator<int>::allocate(unsigned long, void const*)>:
    ...
    2247:	e8 c4 ff ff ff       	callq  2210 <__gnu_cxx::new_allocator<int>::max_size() const>
    224c:	48 39 45 f0          	cmp    %rax,-0x10(%rbp)
    2250:	0f 97 c0             	seta   %al
    2253:	84 c0                	test   %al,%al
    2255:	74 05                	je     225c <__gnu_cxx::new_allocator<int>::allocate(unsigned long, void const*)+0x34>
    2257:	e8 14 ef ff ff       	callq  1170 <std::__throw_bad_alloc()@plt>
    225c:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    2260:	48 c1 e0 02          	shl    $0x2,%rax
    2264:	48 89 c7             	mov    %rax,%rdi
    2267:	e8 84 ef ff ff       	callq  11f0 <operator new(unsigned long)@plt>
    226c:	c9                   	leaveq 
    226d:	c3                   	retq   

000000000000226e <int* std::__copy_move<false, true, std::random_access_iterator_tag>::__copy_m<int>(int const*, int const*, int*)>:
    ...
    229b:	74 1f                	je     22bc <int* std::__copy_move<false, true, std::random_access_iterator_tag>::__copy_m<int>(int const*, int const*, int*)+0x4e>
...
00000000000022d2 <std::vector<int, std::allocator<int> >::~vector()>:
    ...
    22e9:	e8 ba f9 ff ff       	callq  1ca8 <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    ...
    2306:	e8 52 fa ff ff       	callq  1d5d <void std::_Destroy<int*, int>(int*, int*, std::allocator<int>&)>
    230b:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    230f:	48 89 c7             	mov    %rax,%rdi
    2312:	e8 13 f4 ff ff       	callq  172a <std::_Vector_base<int, std::allocator<int> >::~_Vector_base()>
    2317:	90                   	nop
    2318:	c9                   	leaveq 
    2319:	c3                   	retq   
