...
0000000000001369 <part_a(int)>:
    ...
    13b9:	e8 7a 03 00 00       	callq  1738 <std::vector<int, std::allocator<int> >::operator[](unsigned long)>
    ...
    13cd:	48 8d 3d 6c 3c 00 00 	lea    0x3c6c(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    13d4:	e8 37 fe ff ff       	callq  1210 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char)@plt>
    13d9:	83 45 ec 01          	addl   $0x1,-0x14(%rbp)
    13dd:	eb ae                	jmp    138d <part_a(int)+0x24>
    13df:	48 8d 35 23 1d 00 00 	lea    0x1d23(%rip),%rsi        # 3109 <std::__detail::_S_invalid_state_id+0x61>
    13e6:	48 8d 3d 53 3c 00 00 	lea    0x3c53(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    13ed:	e8 ee fd ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    13f2:	48 8d 35 12 1d 00 00 	lea    0x1d12(%rip),%rsi        # 310b <std::__detail::_S_invalid_state_id+0x63>
    13f9:	48 8d 3d 40 3c 00 00 	lea    0x3c40(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    1400:	e8 db fd ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    1405:	48 89 c3             	mov    %rax,%rbx
    1408:	e8 53 fd ff ff       	callq  1160 <rand@plt>
    140d:	89 c6                	mov    %eax,%esi
    140f:	48 89 df             	mov    %rbx,%rdi
    1412:	e8 49 fe ff ff       	callq  1260 <std::ostream::operator<<(int)@plt>
    1417:	48 8d 35 eb 1c 00 00 	lea    0x1ceb(%rip),%rsi        # 3109 <std::__detail::_S_invalid_state_id+0x61>
    141e:	48 89 c7             	mov    %rax,%rdi
    1421:	e8 ba fd ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    1426:	eb 13                	jmp    143b <part_a(int)+0xd2>
    1428:	48 8d 35 f4 1c 00 00 	lea    0x1cf4(%rip),%rsi        # 3123 <std::__detail::_S_invalid_state_id+0x7b>
    142f:	48 8d 3d 0a 3c 00 00 	lea    0x3c0a(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    1436:	e8 a5 fd ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    143b:	90                   	nop
...
0000000000001443 <main>:
    ...
    1463:	48 8d 35 ce 1c 00 00 	lea    0x1cce(%rip),%rsi        # 3138 <std::__detail::_S_invalid_state_id+0x90>
    146a:	48 8d 3d cf 3b 00 00 	lea    0x3bcf(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    1471:	e8 6a fd ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    ...
    14c9:	e8 8e 02 00 00       	callq  175c <std::vector<int, std::allocator<int> >::operator=(std::initializer_list<int>)>
    14ce:	48 8d 35 b3 1c 00 00 	lea    0x1cb3(%rip),%rsi        # 3188 <std::__detail::_S_invalid_state_id+0xe0>
    14d5:	48 8d 3d 64 3b 00 00 	lea    0x3b64(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    14dc:	e8 ff fc ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    14e1:	48 8d 45 b8          	lea    -0x48(%rbp),%rax
    14e5:	48 89 c6             	mov    %rax,%rsi
    14e8:	48 8d 3d 71 3c 00 00 	lea    0x3c71(%rip),%rdi        # 5160 <std::cin@@GLIBCXX_3.4>
    14ef:	e8 ac fc ff ff       	callq  11a0 <std::istream::operator>>(int&)@plt>
    14f4:	48 8d 35 a5 1c 00 00 	lea    0x1ca5(%rip),%rsi        # 31a0 <std::__detail::_S_invalid_state_id+0xf8>
    14fb:	48 8d 3d 3e 3b 00 00 	lea    0x3b3e(%rip),%rdi        # 5040 <std::cout@@GLIBCXX_3.4>
    1502:	e8 d9 fc ff ff       	callq  11e0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
    1507:	48 8d 45 bc          	lea    -0x44(%rbp),%rax
    150b:	48 89 c6             	mov    %rax,%rsi
    150e:	48 8d 3d 4b 3c 00 00 	lea    0x3c4b(%rip),%rdi        # 5160 <std::cin@@GLIBCXX_3.4>
    1515:	e8 86 fc ff ff       	callq  11a0 <std::istream::operator>>(int&)@plt>
    ...
    152e:	e8 36 fe ff ff       	callq  1369 <part_a(int)>
...
0000000000001557 <__static_initialization_and_destruction_0(int, int)>:
    ...
    156d:	75 58                	jne    15c7 <__static_initialization_and_destruction_0(int, int)+0x70>
    156f:	81 7d f8 ff ff 00 00 	cmpl   $0xffff,-0x8(%rbp)
    1576:	75 4f                	jne    15c7 <__static_initialization_and_destruction_0(int, int)+0x70>
    1578:	48 8d 3d 19 3d 00 00 	lea    0x3d19(%rip),%rdi        # 5298 <std::__ioinit>
    157f:	e8 ac fc ff ff       	callq  1230 <std::ios_base::Init::Init()@plt>
    1584:	48 8d 15 7d 3a 00 00 	lea    0x3a7d(%rip),%rdx        # 5008 <__dso_handle>
    158b:	48 8d 35 06 3d 00 00 	lea    0x3d06(%rip),%rsi        # 5298 <std::__ioinit>
    1592:	48 8b 05 5f 3a 00 00 	mov    0x3a5f(%rip),%rax        # 4ff8 <std::ios_base::Init::~Init()@GLIBCXX_3.4>
    ...
    15a8:	e8 a5 00 00 00       	callq  1652 <std::vector<int, std::allocator<int> >::vector()>
    15ad:	48 8d 15 54 3a 00 00 	lea    0x3a54(%rip),%rdx        # 5008 <__dso_handle>
    15b4:	48 8d 35 c5 3c 00 00 	lea    0x3cc5(%rip),%rsi        # 5280 <v>
    15bb:	48 8d 3d a4 0c 00 00 	lea    0xca4(%rip),%rdi        # 2266 <std::vector<int, std::allocator<int> >::~vector()>
...
00000000000015ca <_GLOBAL__sub_I_letters>:
    ...
    15dc:	e8 76 ff ff ff       	callq  1557 <__static_initialization_and_destruction_0(int, int)>
    15e1:	5d                   	pop    %rbp
    15e2:	c3                   	retq   

00000000000015e3 <unsigned long const& std::min<unsigned long>(unsigned long const&, unsigned long const&)>:
    ...
    1604:	73 06                	jae    160c <unsigned long const& std::min<unsigned long>(unsigned long const&, unsigned long const&)+0x29>
    1606:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    160a:	eb 04                	jmp    1610 <unsigned long const& std::min<unsigned long>(unsigned long const&, unsigned long const&)+0x2d>
    160c:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1610:	5d                   	pop    %rbp
    1611:	c3                   	retq   

0000000000001612 <std::_Vector_base<int, std::allocator<int> >::_Vector_impl::~_Vector_impl()>:
    ...
    1629:	e8 70 00 00 00       	callq  169e <std::allocator<int>::~allocator()>
    162e:	90                   	nop
    162f:	c9                   	leaveq 
    1630:	c3                   	retq   
    1631:	90                   	nop

0000000000001632 <std::_Vector_base<int, std::allocator<int> >::_Vector_base()>:
    ...
    1649:	e8 24 00 00 00       	callq  1672 <std::_Vector_base<int, std::allocator<int> >::_Vector_impl::_Vector_impl()>
    164e:	90                   	nop
    164f:	c9                   	leaveq 
    1650:	c3                   	retq   
    1651:	90                   	nop

0000000000001652 <std::vector<int, std::allocator<int> >::vector()>:
    ...
    1669:	e8 c4 ff ff ff       	callq  1632 <std::_Vector_base<int, std::allocator<int> >::_Vector_base()>
    166e:	90                   	nop
    166f:	c9                   	leaveq 
    1670:	c3                   	retq   
    1671:	90                   	nop

0000000000001672 <std::_Vector_base<int, std::allocator<int> >::_Vector_impl::_Vector_impl()>:
    ...
    1689:	e8 52 01 00 00       	callq  17e0 <std::allocator<int>::allocator()>
    168e:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1692:	48 89 c7             	mov    %rax,%rdi
    1695:	e8 66 01 00 00       	callq  1800 <std::_Vector_base<int, std::allocator<int> >::_Vector_impl_data::_Vector_impl_data()>
    169a:	90                   	nop
    169b:	c9                   	leaveq 
    169c:	c3                   	retq   
    169d:	90                   	nop

000000000000169e <std::allocator<int>::~allocator()>:
    ...
    16b5:	e8 78 01 00 00       	callq  1832 <__gnu_cxx::new_allocator<int>::~new_allocator()>
    16ba:	90                   	nop
    16bb:	c9                   	leaveq 
    16bc:	c3                   	retq   
    16bd:	90                   	nop

00000000000016be <std::_Vector_base<int, std::allocator<int> >::~_Vector_base()>:
    ...
    16fb:	e8 42 01 00 00       	callq  1842 <std::_Vector_base<int, std::allocator<int> >::_M_deallocate(int*, unsigned long)>
    1700:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1704:	48 89 c7             	mov    %rax,%rdi
    1707:	e8 06 ff ff ff       	callq  1612 <std::_Vector_base<int, std::allocator<int> >::_Vector_impl::~_Vector_impl()>
    170c:	90                   	nop
    170d:	c9                   	leaveq 
    170e:	c3                   	retq   
    170f:	90                   	nop

0000000000001710 <std::vector<int, std::allocator<int> >::size() const>:
...
0000000000001738 <std::vector<int, std::allocator<int> >::operator[](unsigned long)>:
...
000000000000175c <std::vector<int, std::allocator<int> >::operator=(std::initializer_list<int>)>:
    ...
    1797:	e8 f6 00 00 00       	callq  1892 <std::initializer_list<int>::end() const>
    179c:	48 89 c3             	mov    %rax,%rbx
    179f:	48 8d 45 c0          	lea    -0x40(%rbp),%rax
    17a3:	48 89 c7             	mov    %rax,%rdi
    17a6:	e8 d1 00 00 00       	callq  187c <std::initializer_list<int>::begin() const>
    ...
    17bb:	e8 0c 01 00 00       	callq  18cc <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)>
    17c0:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    17c4:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx
    17c8:	64 48 33 14 25 28 00 	xor    %fs:0x28,%rdx
    17cf:	00 00 
    17d1:	74 05                	je     17d8 <std::vector<int, std::allocator<int> >::operator=(std::initializer_list<int>)+0x7c>
...
00000000000017e0 <std::allocator<int>::allocator()>:
    ...
    17f7:	e8 e4 02 00 00       	callq  1ae0 <__gnu_cxx::new_allocator<int>::new_allocator()>
    17fc:	90                   	nop
    17fd:	c9                   	leaveq 
    17fe:	c3                   	retq   
    17ff:	90                   	nop

0000000000001800 <std::_Vector_base<int, std::allocator<int> >::_Vector_impl_data::_Vector_impl_data()>:
...
0000000000001832 <__gnu_cxx::new_allocator<int>::~new_allocator()>:
...
0000000000001842 <std::_Vector_base<int, std::allocator<int> >::_M_deallocate(int*, unsigned long)>:
    ...
    185f:	74 17                	je     1878 <std::_Vector_base<int, std::allocator<int> >::_M_deallocate(int*, unsigned long)+0x36>
    ...
    1873:	e8 77 02 00 00       	callq  1aef <std::allocator_traits<std::allocator<int> >::deallocate(std::allocator<int>&, int*, unsigned long)>
    1878:	90                   	nop
    1879:	c9                   	leaveq 
    187a:	c3                   	retq   
    187b:	90                   	nop

000000000000187c <std::initializer_list<int>::begin() const>:
...
0000000000001892 <std::initializer_list<int>::end() const>:
    ...
    18aa:	e8 cd ff ff ff       	callq  187c <std::initializer_list<int>::begin() const>
    18af:	48 89 c3             	mov    %rax,%rbx
    18b2:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    18b6:	48 89 c7             	mov    %rax,%rdi
    18b9:	e8 64 02 00 00       	callq  1b22 <std::initializer_list<int>::size() const>
...
00000000000018cc <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)>:
    ...
    1901:	e8 32 02 00 00       	callq  1b38 <std::iterator_traits<int const*>::difference_type std::distance<int const*>(int const*, int const*)>
    1906:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    190a:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    190e:	48 89 c7             	mov    %rax,%rdi
    1911:	e8 7a 02 00 00       	callq  1b90 <std::vector<int, std::allocator<int> >::capacity() const>
    1916:	48 39 45 e0          	cmp    %rax,-0x20(%rbp)
    191a:	0f 97 c0             	seta   %al
    191d:	84 c0                	test   %al,%al
    191f:	0f 84 d2 00 00 00    	je     19f7 <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)+0x12b>
    1925:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1929:	48 89 c7             	mov    %rax,%rdi
    192c:	e8 0b 03 00 00       	callq  1c3c <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    1931:	48 89 c2             	mov    %rax,%rdx
    1934:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1938:	48 89 d6             	mov    %rdx,%rsi
    193b:	48 89 c7             	mov    %rax,%rdi
    193e:	e8 74 02 00 00       	callq  1bb7 <std::vector<int, std::allocator<int> >::_S_check_init_len(unsigned long, std::allocator<int> const&)>
    ...
    1956:	e8 f3 02 00 00       	callq  1c4e <int* std::vector<int, std::allocator<int> >::_M_allocate_and_copy<int const*>(unsigned long, int const*, int const*)>
    195b:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    195f:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1963:	48 89 c7             	mov    %rax,%rdi
    1966:	e8 d1 02 00 00       	callq  1c3c <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    ...
    1983:	e8 69 03 00 00       	callq  1cf1 <void std::_Destroy<int*, int>(int*, int*, std::allocator<int>&)>
    ...
    19b8:	e8 85 fe ff ff       	callq  1842 <std::_Vector_base<int, std::allocator<int> >::_M_deallocate(int*, unsigned long)>
    ...
    19f2:	e9 d1 00 00 00       	jmpq   1ac8 <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)+0x1fc>
    19f7:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    19fb:	48 89 c7             	mov    %rax,%rdi
    19fe:	e8 0d fd ff ff       	callq  1710 <std::vector<int, std::allocator<int> >::size() const>
    1a03:	48 39 45 e0          	cmp    %rax,-0x20(%rbp)
    1a07:	0f 96 c0             	setbe  %al
    1a0a:	84 c0                	test   %al,%al
    1a0c:	74 31                	je     1a3f <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)+0x173>
    ...
    1a23:	e8 5c 03 00 00       	callq  1d84 <int* std::copy<int const*, int*>(int const*, int const*, int*)>
    1a28:	48 89 c2             	mov    %rax,%rdx
    1a2b:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1a2f:	48 89 d6             	mov    %rdx,%rsi
    1a32:	48 89 c7             	mov    %rax,%rdi
    1a35:	e8 e6 02 00 00       	callq  1d20 <std::vector<int, std::allocator<int> >::_M_erase_at_end(int*)>
    1a3a:	e9 89 00 00 00       	jmpq   1ac8 <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)+0x1fc>
    ...
    1a4e:	e8 bd fc ff ff       	callq  1710 <std::vector<int, std::allocator<int> >::size() const>
    1a53:	48 89 c2             	mov    %rax,%rdx
    1a56:	48 8d 45 d8          	lea    -0x28(%rbp),%rax
    1a5a:	48 89 d6             	mov    %rdx,%rsi
    1a5d:	48 89 c7             	mov    %rax,%rdi
    1a60:	e8 6f 03 00 00       	callq  1dd4 <void std::advance<int const*, unsigned long>(int const*&, unsigned long)>
    ...
    1a7a:	e8 05 03 00 00       	callq  1d84 <int* std::copy<int const*, int*>(int const*, int const*, int*)>
    1a7f:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1a83:	48 89 c7             	mov    %rax,%rdi
    1a86:	e8 85 fc ff ff       	callq  1710 <std::vector<int, std::allocator<int> >::size() const>
    ...
    1aa0:	e8 97 01 00 00       	callq  1c3c <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    ...
    1abb:	e8 75 03 00 00       	callq  1e35 <int* std::__uninitialized_copy_a<int const*, int*, int>(int const*, int const*, int*, std::allocator<int>&)>
    ...
    1ad4:	00 00 
    1ad6:	74 05                	je     1add <void std::vector<int, std::allocator<int> >::_M_assign_aux<int const*>(int const*, int const*, std::forward_iterator_tag)+0x211>
    1ad8:	e8 23 f7 ff ff       	callq  1200 <__stack_chk_fail@plt>
    1add:	c9                   	leaveq 
    1ade:	c3                   	retq   
    1adf:	90                   	nop

0000000000001ae0 <__gnu_cxx::new_allocator<int>::new_allocator()>:
...
0000000000001aef <std::allocator_traits<std::allocator<int> >::deallocate(std::allocator<int>&, int*, unsigned long)>:
    ...
    1b19:	e8 4c 03 00 00       	callq  1e6a <__gnu_cxx::new_allocator<int>::deallocate(int*, unsigned long)>
    1b1e:	90                   	nop
    1b1f:	c9                   	leaveq 
    1b20:	c3                   	retq   
    1b21:	90                   	nop

0000000000001b22 <std::initializer_list<int>::size() const>:
...
0000000000001b38 <std::iterator_traits<int const*>::difference_type std::distance<int const*>(int const*, int const*)>:
    ...
    1b62:	e8 2a 03 00 00       	callq  1e91 <std::iterator_traits<int const*>::iterator_category std::__iterator_category<int const*>(int const* const&)>
    1b67:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1b6b:	48 8b 55 e0          	mov    -0x20(%rbp),%rdx
    1b6f:	48 89 d6             	mov    %rdx,%rsi
    1b72:	48 89 c7             	mov    %rax,%rdi
    1b75:	e8 25 03 00 00       	callq  1e9f <std::iterator_traits<int const*>::difference_type std::__distance<int const*>(int const*, int const*, std::random_access_iterator_tag)>
    1b7a:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1b7e:	64 48 33 0c 25 28 00 	xor    %fs:0x28,%rcx
    1b85:	00 00 
    1b87:	74 05                	je     1b8e <std::iterator_traits<int const*>::difference_type std::distance<int const*>(int const*, int const*)+0x56>
    1b89:	e8 72 f6 ff ff       	callq  1200 <__stack_chk_fail@plt>
    1b8e:	c9                   	leaveq 
    1b8f:	c3                   	retq   

0000000000001b90 <std::vector<int, std::allocator<int> >::capacity() const>:
...
0000000000001bb7 <std::vector<int, std::allocator<int> >::_S_check_init_len(unsigned long, std::allocator<int> const&)>:
    ...
    1be9:	e8 38 03 00 00       	callq  1f26 <std::allocator<int>::allocator(std::allocator<int> const&)>
    1bee:	48 8d 45 e7          	lea    -0x19(%rbp),%rax
    1bf2:	48 89 c7             	mov    %rax,%rdi
    1bf5:	e8 c3 02 00 00       	callq  1ebd <std::vector<int, std::allocator<int> >::_S_max_size(std::allocator<int> const&)>
    1bfa:	48 39 45 d8          	cmp    %rax,-0x28(%rbp)
    1bfe:	0f 97 c3             	seta   %bl
    1c01:	48 8d 45 e7          	lea    -0x19(%rbp),%rax
    1c05:	48 89 c7             	mov    %rax,%rdi
    1c08:	e8 91 fa ff ff       	callq  169e <std::allocator<int>::~allocator()>
    1c0d:	84 db                	test   %bl,%bl
    1c0f:	74 0c                	je     1c1d <std::vector<int, std::allocator<int> >::_S_check_init_len(unsigned long, std::allocator<int> const&)+0x66>
    1c11:	48 8d 3d a8 15 00 00 	lea    0x15a8(%rip),%rdi        # 31c0 <std::__detail::_S_invalid_state_id+0x118>
    1c18:	e8 73 f5 ff ff       	callq  1190 <std::__throw_length_error(char const*)@plt>
    1c1d:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    1c21:	48 8b 4d e8          	mov    -0x18(%rbp),%rcx
    1c25:	64 48 33 0c 25 28 00 	xor    %fs:0x28,%rcx
    1c2c:	00 00 
    1c2e:	74 05                	je     1c35 <std::vector<int, std::allocator<int> >::_S_check_init_len(unsigned long, std::allocator<int> const&)+0x7e>
...
0000000000001c3c <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>:
...
0000000000001c4e <int* std::vector<int, std::allocator<int> >::_M_allocate_and_copy<int const*>(unsigned long, int const*, int const*)>:
    ...
    1c79:	e8 d2 02 00 00       	callq  1f50 <std::_Vector_base<int, std::allocator<int> >::_M_allocate(unsigned long)>
    1c7e:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    1c82:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    1c86:	48 89 c7             	mov    %rax,%rdi
    1c89:	e8 ae ff ff ff       	callq  1c3c <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    ...
    1ca0:	e8 90 01 00 00       	callq  1e35 <int* std::__uninitialized_copy_a<int const*, int*, int>(int const*, int const*, int*, std::allocator<int>&)>
    1ca5:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1ca9:	eb 3f                	jmp    1cea <int* std::vector<int, std::allocator<int> >::_M_allocate_and_copy<int const*>(unsigned long, int const*, int const*)+0x9c>
    ...
    1cc9:	e8 74 fb ff ff       	callq  1842 <std::_Vector_base<int, std::allocator<int> >::_M_deallocate(int*, unsigned long)>
...
0000000000001cf1 <void std::_Destroy<int*, int>(int*, int*, std::allocator<int>&)>:
    ...
    1d17:	e8 6b 02 00 00       	callq  1f87 <void std::_Destroy<int*>(int*, int*)>
    1d1c:	90                   	nop
    1d1d:	c9                   	leaveq 
    1d1e:	c3                   	retq   
    1d1f:	90                   	nop

0000000000001d20 <std::vector<int, std::allocator<int> >::_M_erase_at_end(int*)>:
    ...
    1d4d:	74 32                	je     1d81 <std::vector<int, std::allocator<int> >::_M_erase_at_end(int*)+0x61>
    1d4f:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1d53:	48 89 c7             	mov    %rax,%rdi
    1d56:	e8 e1 fe ff ff       	callq  1c3c <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    ...
    1d70:	e8 7c ff ff ff       	callq  1cf1 <void std::_Destroy<int*, int>(int*, int*, std::allocator<int>&)>
...
0000000000001d84 <int* std::copy<int const*, int*>(int const*, int const*, int*)>:
    ...
    1da4:	e8 08 02 00 00       	callq  1fb1 <int const* std::__miter_base<int const*>(int const*)>
    1da9:	48 89 c3             	mov    %rax,%rbx
    1dac:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1db0:	48 89 c7             	mov    %rax,%rdi
    1db3:	e8 f9 01 00 00       	callq  1fb1 <int const* std::__miter_base<int const*>(int const*)>
    ...
    1dc8:	e8 f6 01 00 00       	callq  1fc3 <int* std::__copy_move_a2<false, int const*, int*>(int const*, int const*, int*)>
    1dcd:	48 83 c4 28          	add    $0x28,%rsp
    1dd1:	5b                   	pop    %rbx
    1dd2:	5d                   	pop    %rbp
    1dd3:	c3                   	retq   

0000000000001dd4 <void std::advance<int const*, unsigned long>(int const*&, unsigned long)>:
    ...
    1e06:	e8 86 00 00 00       	callq  1e91 <std::iterator_traits<int const*>::iterator_category std::__iterator_category<int const*>(int const* const&)>
    1e0b:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    1e0f:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    1e13:	48 89 d6             	mov    %rdx,%rsi
    1e16:	48 89 c7             	mov    %rax,%rdi
    1e19:	e8 13 02 00 00       	callq  2031 <void std::__advance<int const*, long>(int const*&, long, std::random_access_iterator_tag)>
    1e1e:	90                   	nop
    1e1f:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1e23:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax
    1e2a:	00 00 
    1e2c:	74 05                	je     1e33 <void std::advance<int const*, unsigned long>(int const*&, unsigned long)+0x5f>
    1e2e:	e8 cd f3 ff ff       	callq  1200 <__stack_chk_fail@plt>
    1e33:	c9                   	leaveq 
    1e34:	c3                   	retq   

0000000000001e35 <int* std::__uninitialized_copy_a<int const*, int*, int>(int const*, int const*, int*, std::allocator<int>&)>:
    ...
    1e63:	e8 f5 01 00 00       	callq  205d <int* std::uninitialized_copy<int const*, int*>(int const*, int const*, int*)>
    1e68:	c9                   	leaveq 
    1e69:	c3                   	retq   

0000000000001e6a <__gnu_cxx::new_allocator<int>::deallocate(int*, unsigned long)>:
    ...
    1e89:	e8 32 f3 ff ff       	callq  11c0 <operator delete(void*)@plt>
    1e8e:	90                   	nop
    1e8f:	c9                   	leaveq 
    1e90:	c3                   	retq   

0000000000001e91 <std::iterator_traits<int const*>::iterator_category std::__iterator_category<int const*>(int const* const&)>:
...
0000000000001e9f <std::iterator_traits<int const*>::difference_type std::__distance<int const*>(int const*, int const*, std::random_access_iterator_tag)>:
...
0000000000001ebd <std::vector<int, std::allocator<int> >::_S_max_size(std::allocator<int> const&)>:
    ...
    1ef1:	e8 9c 01 00 00       	callq  2092 <std::allocator_traits<std::allocator<int> >::max_size(std::allocator<int> const&)>
    ...
    1f08:	e8 d6 f6 ff ff       	callq  15e3 <unsigned long const& std::min<unsigned long>(unsigned long const&, unsigned long const&)>
    1f0d:	48 8b 00             	mov    (%rax),%rax
    1f10:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1f14:	64 48 33 0c 25 28 00 	xor    %fs:0x28,%rcx
    1f1b:	00 00 
    1f1d:	74 05                	je     1f24 <std::vector<int, std::allocator<int> >::_S_max_size(std::allocator<int> const&)+0x67>
    1f1f:	e8 dc f2 ff ff       	callq  1200 <__stack_chk_fail@plt>
    1f24:	c9                   	leaveq 
    1f25:	c3                   	retq   

0000000000001f26 <std::allocator<int>::allocator(std::allocator<int> const&)>:
    ...
    1f48:	e8 63 01 00 00       	callq  20b0 <__gnu_cxx::new_allocator<int>::new_allocator(__gnu_cxx::new_allocator<int> const&)>
    1f4d:	90                   	nop
    1f4e:	c9                   	leaveq 
    1f4f:	c3                   	retq   

0000000000001f50 <std::_Vector_base<int, std::allocator<int> >::_M_allocate(unsigned long)>:
    ...
    1f69:	74 15                	je     1f80 <std::_Vector_base<int, std::allocator<int> >::_M_allocate(unsigned long)+0x30>
    1f6b:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1f6f:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    1f73:	48 89 d6             	mov    %rdx,%rsi
    1f76:	48 89 c7             	mov    %rax,%rdi
    1f79:	e8 45 01 00 00       	callq  20c3 <std::allocator_traits<std::allocator<int> >::allocate(std::allocator<int>&, unsigned long)>
    1f7e:	eb 05                	jmp    1f85 <std::_Vector_base<int, std::allocator<int> >::_M_allocate(unsigned long)+0x35>
    1f80:	b8 00 00 00 00       	mov    $0x0,%eax
    1f85:	c9                   	leaveq 
    1f86:	c3                   	retq   

0000000000001f87 <void std::_Destroy<int*>(int*, int*)>:
    ...
    1fa9:	e8 43 01 00 00       	callq  20f1 <void std::_Destroy_aux<true>::__destroy<int*>(int*, int*)>
    1fae:	90                   	nop
    1faf:	c9                   	leaveq 
    1fb0:	c3                   	retq   

0000000000001fb1 <int const* std::__miter_base<int const*>(int const*)>:
...
0000000000001fc3 <int* std::__copy_move_a2<false, int const*, int*>(int const*, int const*, int*)>:
    ...
    1fe5:	e8 2c 01 00 00       	callq  2116 <int* std::__niter_base<int*>(int*)>
    1fea:	49 89 c4             	mov    %rax,%r12
    1fed:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1ff1:	48 89 c7             	mov    %rax,%rdi
    1ff4:	e8 0b 01 00 00       	callq  2104 <int const* std::__niter_base<int const*>(int const*)>
    1ff9:	48 89 c3             	mov    %rax,%rbx
    1ffc:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    2000:	48 89 c7             	mov    %rax,%rdi
    2003:	e8 fc 00 00 00       	callq  2104 <int const* std::__niter_base<int const*>(int const*)>
    2008:	4c 89 e2             	mov    %r12,%rdx
    200b:	48 89 de             	mov    %rbx,%rsi
    200e:	48 89 c7             	mov    %rax,%rdi
    2011:	e8 12 01 00 00       	callq  2128 <int* std::__copy_move_a<false, int const*, int*>(int const*, int const*, int*)>
    2016:	48 89 c2             	mov    %rax,%rdx
    2019:	48 8d 45 d8          	lea    -0x28(%rbp),%rax
    201d:	48 89 d6             	mov    %rdx,%rsi
    2020:	48 89 c7             	mov    %rax,%rdi
    2023:	e8 35 01 00 00       	callq  215d <int* std::__niter_wrap<int*>(int* const&, int*)>
...
0000000000002031 <void std::__advance<int const*, long>(int const*&, long, std::random_access_iterator_tag)>:
...
000000000000205d <int* std::uninitialized_copy<int const*, int*>(int const*, int const*, int*)>:
    ...
    208b:	e8 e3 00 00 00       	callq  2173 <int* std::__uninitialized_copy<true>::__uninit_copy<int const*, int*>(int const*, int const*, int*)>
    2090:	c9                   	leaveq 
    2091:	c3                   	retq   

0000000000002092 <std::allocator_traits<std::allocator<int> >::max_size(std::allocator<int> const&)>:
    ...
    20a9:	e8 f6 00 00 00       	callq  21a4 <__gnu_cxx::new_allocator<int>::max_size() const>
    20ae:	c9                   	leaveq 
    20af:	c3                   	retq   

00000000000020b0 <__gnu_cxx::new_allocator<int>::new_allocator(__gnu_cxx::new_allocator<int> const&)>:
...
00000000000020c3 <std::allocator_traits<std::allocator<int> >::allocate(std::allocator<int>&, unsigned long)>:
    ...
    20ea:	e8 cd 00 00 00       	callq  21bc <__gnu_cxx::new_allocator<int>::allocate(unsigned long, void const*)>
    20ef:	c9                   	leaveq 
    20f0:	c3                   	retq   

00000000000020f1 <void std::_Destroy_aux<true>::__destroy<int*>(int*, int*)>:
...
0000000000002104 <int const* std::__niter_base<int const*>(int const*)>:
...
0000000000002116 <int* std::__niter_base<int*>(int*)>:
...
0000000000002128 <int* std::__copy_move_a<false, int const*, int*>(int const*, int const*, int*)>:
    ...
    2156:	e8 a7 00 00 00       	callq  2202 <int* std::__copy_move<false, true, std::random_access_iterator_tag>::__copy_m<int>(int const*, int const*, int*)>
    215b:	c9                   	leaveq 
    215c:	c3                   	retq   

000000000000215d <int* std::__niter_wrap<int*>(int* const&, int*)>:
...
0000000000002173 <int* std::__uninitialized_copy<true>::__uninit_copy<int const*, int*>(int const*, int const*, int*)>:
    ...
    219d:	e8 e2 fb ff ff       	callq  1d84 <int* std::copy<int const*, int*>(int const*, int const*, int*)>
    21a2:	c9                   	leaveq 
    21a3:	c3                   	retq   

00000000000021a4 <__gnu_cxx::new_allocator<int>::max_size() const>:
...
00000000000021bc <__gnu_cxx::new_allocator<int>::allocate(unsigned long, void const*)>:
    ...
    21db:	e8 c4 ff ff ff       	callq  21a4 <__gnu_cxx::new_allocator<int>::max_size() const>
    21e0:	48 39 45 f0          	cmp    %rax,-0x10(%rbp)
    21e4:	0f 97 c0             	seta   %al
    21e7:	84 c0                	test   %al,%al
    21e9:	74 05                	je     21f0 <__gnu_cxx::new_allocator<int>::allocate(unsigned long, void const*)+0x34>
    21eb:	e8 80 ef ff ff       	callq  1170 <std::__throw_bad_alloc()@plt>
    21f0:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    21f4:	48 c1 e0 02          	shl    $0x2,%rax
    21f8:	48 89 c7             	mov    %rax,%rdi
    21fb:	e8 f0 ef ff ff       	callq  11f0 <operator new(unsigned long)@plt>
    2200:	c9                   	leaveq 
    2201:	c3                   	retq   

0000000000002202 <int* std::__copy_move<false, true, std::random_access_iterator_tag>::__copy_m<int>(int const*, int const*, int*)>:
    ...
    222f:	74 1f                	je     2250 <int* std::__copy_move<false, true, std::random_access_iterator_tag>::__copy_m<int>(int const*, int const*, int*)+0x4e>
...
0000000000002266 <std::vector<int, std::allocator<int> >::~vector()>:
    ...
    227d:	e8 ba f9 ff ff       	callq  1c3c <std::_Vector_base<int, std::allocator<int> >::_M_get_Tp_allocator()>
    ...
    229a:	e8 52 fa ff ff       	callq  1cf1 <void std::_Destroy<int*, int>(int*, int*, std::allocator<int>&)>
    229f:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    22a3:	48 89 c7             	mov    %rax,%rdi
    22a6:	e8 13 f4 ff ff       	callq  16be <std::_Vector_base<int, std::allocator<int> >::~_Vector_base()>
    22ab:	90                   	nop
    22ac:	c9                   	leaveq 
    22ad:	c3                   	retq   
